...
public class MyComplex {
    ...
    public boolean equals(MyComplex another) {
        if (compare(this.real, another.getReal())==0 && compare(this.imag, another.getImag())==0) return true;
        else
            return false;
    }
    ...
    public boolean equals(double real, double imag){
        if (compare(this.real, real) == 0 && compare(this.imag, imag) == 0) return true;
        else
            return false;
    }
